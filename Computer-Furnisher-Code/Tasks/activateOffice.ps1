$taskDefinition = [PSCustomObject]@{
    identifier="activateOffice";
    isRerunnable=$false;
    sequence=1;
}
$taskDefinition | Add-Member -Name 'ValidateFunction' -Type ScriptMethod -Value { ActivateOfficeValidation }
$taskDefinition | Add-Member -Name 'ExecuteFunction' -Type ScriptMethod -Value { ActivateOfficeExecution }
$global:tasks += $taskDefinition

Function ActivateOfficeValidation () {
...
Function ActivateOfficeExecution() {
